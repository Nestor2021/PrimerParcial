...
namespace CALCULE_EL_PRECIO_DE_VENTA_DE_PRODUCTOS.Entidades
{
    class Venta
    {
        ...
        public Venta(int x, int identificaciordeproducto, string nombre_producto, string descripcion_del_producto, double precio_del_producto, int cantidad, double descuento, double total)
        {
            this.x = x;
            this.identificaciordeproducto = identificaciordeproducto;
        ...
        public Venta( int identificaciordeproducto, string nombre_producto, string descripcion_del_producto, double precio_del_producto, int cantidad)
        {
